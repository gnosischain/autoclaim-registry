...
import "./interfaces/IClaimRegistryUpgradeableOld.sol";
 ...
 */
contract ClaimRegistryUpgradeableOld is IClaimRegistryUpgradeableOld, UUPSUpgradeable, OwnableUpgradeable {
    // State variables
    enum ConfigStatus {
        INACTIVE,
        ACTIVE
